# Generated by Django 4.2.1 on 2023-10-11 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auth_level', models.CharField(choices=[('viewer', 'Viewer'), ('member', 'Member'), ('admin', 'Admin'), ('manager', 'Manager')], default='Member', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fromTo', models.CharField(choices=[('WriterToCompany', 'WtoC'), ('CompanyToWriter', 'CtoW')], default='CtoW', max_length=20)),
        ...
        migrations.AddField(
            model_name='blog',
            name='tags',
            field=models.ManyToManyField(related_name='tag_posts', to='api.tag'),
        ),
    ]
